  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-transparent">
      <div className="bg-[#23243a] bg-opacity-90 p-12 rounded-xl shadow-lg flex flex-col items-center relative z-10">
        <h1 className="text-3xl font-bold mb-8 tracking-widest font-mono uppercase bg-gradient-to-r from-cyan-300 via-blue-400 to-purple-400 bg-clip-text text-transparent select-none">
          MEMORIZER
        </h1>
        <button
